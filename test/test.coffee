...
describe 'CoffeeTemplates', ->
  ...
  describe 'All-in-One: CoffeeCup+Handlebars+Helpers', ->
    it 'compiles multiple Handlebars/Mustache/string templates to a single function, WITH helpers (default)', ->
      ...
      #assert.equal "function anonymous(n,g) {\nvar o=\"\";var c={},p=\"partial\",l=\"layout\",content_for=function(s,f){c[s]=c[s]||[];c[s].push(f)},yields=function(s){while(c[s].length)c[s].pop()()},z=function(g){var y=o,n;if(g&&g.l&&(n=g.l.pop())){content_for(\"content\",function(){o+=y});o=\"\";g[p](n,g);}},__if=function(v,f){v&&v.length!==0&&f()},each=function(o,f){for (var k in o)o.hasOwnProperty(k)&&f.apply(o[k],[k,o[k]])};g=g||{};g.l=[g[l]];g[l]=function(n){g.l.push(n)};g[p]=function(n,e){e=e||{};for(var k in g){e[k]=e[k]||g[k]};var q=g.l;g.l=[];with(e){var w=function(f,a){o=\"\";f.apply({},a);return o},t={\n\"A\":function(){return \"Hi, \"+name},\n\"B\":function(){return \"Bye, \"+name},\n}};o+=t[n]();z(g);g.l=q};g[p](n,g);z(g);return o\n}", templates_fn.toString()
    ...
    it 'yields() FIFO pops content_for() more than one layout() up', ->
      templates =
      ...
      assert.equal "<!doctype html><html><head><title>test</title><p>head2</p><p>head2</p><script>alert('hi');</script></head><body><div id=\"wrapper\"><div><p>hello world</p><div><div id=\"wrapper\"><p>goodbye world</p></div></div></div></div><p>foot2</p><p>foot2</p><p>page 1 of 2</p></body></html>", out
